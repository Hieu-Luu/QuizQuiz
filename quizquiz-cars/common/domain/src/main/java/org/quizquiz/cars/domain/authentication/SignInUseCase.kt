...
class SignInUseCase @Inject constructor(private val authRepo: AuthRepository) {
    suspend operator fun invoke(request: AuthRequest): Response<AuthResponse> = authRepo.signin(request)
}